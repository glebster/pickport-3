...
## Основной сценарий (New Entry Wizard, 2 шага)
...
Пользователь видит карточку‑черновик и:
...
Если ИИ не уверен, он предлагает **минимальную форму** и ручной выбор категории/рецепта.
